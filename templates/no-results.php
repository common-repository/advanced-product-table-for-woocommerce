...
?>
<div class="iwptp-no-results  iwptp-device-<?php echo esc_attr($device); ?>" data-iwptp-device="<?php echo esc_attr($device); ?>">
    <?php echo wp_kses(str_replace(array('[link]', '[/link]'), array('<a href="." class="iwptp-clear-filters">', '</a>'), $string), iwptp_allowed_html_tags()); ?>
</div>