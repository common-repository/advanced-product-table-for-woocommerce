<div iwptp-model-key="[container] .iwptp-footer.iwptp-navigation">
...
<!-- Dropdown Heading -->
<div iwptp-model-key="[container] .iwptp-footer.iwptp-navigation .iwptp-dropdown.iwptp-filter > .iwptp-filter-heading">
...
<!-- Dropdown Menu -->
<div iwptp-model-key="[container] .iwptp-footer.iwptp-navigation .iwptp-dropdown.iwptp-filter > .iwptp-dropdown-menu">
...
<!-- Dropdown Search -->
<div iwptp-model-key="[container] .iwptp-footer.iwptp-navigation .iwptp-dropdown.iwptp-filter > .iwptp-dropdown-menu .iwptp-search-filter-options">
    ...
    <div class="iwptp-editor-option-row">
        <label><?php esc_html_e('Margin', 'ithemeland-woocommerce-product-table-pro-lite'); ?></label>
        <input type="text" iwptp-model-key="margin-top" placeholder="top" class="iwptp-width--50-percent">
        <input type="text" iwptp-model-key="margin-bottom" placeholder="bottom" class="iwptp-width--50-percent">
    </div>

</div>

<!-- Row heading -->
<div iwptp-model-key="[container] .iwptp-footer.iwptp-navigation .iwptp-options-row.iwptp-filter > .iwptp-filter-heading">
...
<!-- Row options -->
<div iwptp-model-key="[container] .iwptp-footer.iwptp-navigation .iwptp-options-row.iwptp-filter > .iwptp-options > .iwptp-option">
