<div class="iwptp-editor-option-row iwptp-toggle-options" iwptp-model-key="style">

    <div class="iwptp-editor-row-option iwptp-toggle-label">
        <?php esc_html_e('Column style options', 'ithemeland-woocommerce-product-table-pro-lite'); ?>
    ...
    <div class="iwptp-editor-option-row">
        ...
        <input type="text" iwptp-model-key="padding-top" placeholder="<?php esc_html_e('top', 'ithemeland-woocommerce-product-table-pro-lite'); ?>">
        <input type="text" iwptp-model-key="padding-right" placeholder="<?php esc_html_e('right', 'ithemeland-woocommerce-product-table-pro-lite'); ?>">
        <input type="text" iwptp-model-key="padding-bottom" placeholder="<?php esc_html_e('bottom', 'ithemeland-woocommerce-product-table-pro-lite'); ?>">
        <input type="text" iwptp-model-key="padding-left" placeholder="<?php esc_html_e('left', 'ithemeland-woocommerce-product-table-pro-lite'); ?>">
    </div>
