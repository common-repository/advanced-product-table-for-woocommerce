<?php
include('settings-partials/checkbox-trigger.php');
include('settings-partials/cart-widget.php');
include('settings-partials/modals.php');
include('settings-partials/no-results.php');
include('settings-partials/search_localization.php');
